...
In this game existing cell creatures that are allies, and can be summoned by consuming cell points (CP). That cell creatures can be equipped in the lobby, and that action set a value in memory (a byte is written) or removided (a null byte is written), that cell creature value will be named in this blogpost as cell creature ID. 
